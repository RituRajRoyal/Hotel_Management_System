...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p style="font-weight:800">SUN RISE HOTEL,</p>
				<p style="font-weight:600">Sector-17A,<br>Chandigarh,<br>India.</p>
				<p style="font-weight:600">(+91) 6522244551</p>
			</address>
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					...
					<tr>
						<td><span >Room Type :- <?php echo $room_type; ?></span></td>
						<td><span ><?php echo $nodays; ?> </span></td>
						
					</tr>
					<tr>
						<td><span >Bed Type :- <?php echo $Bed_type; ?> Bed  </span></td>
						<td><span ><?php echo $nodays; ?></span></td>
						
					</tr>
					<tr>
						<td><span >Meal Type :- <?php echo $meal_type  ?>  </span></td>
						<td><span ><?php echo $nodays; ?></span></td>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- info@sunrise.com || Web :- www.sunrise.com || Phone :- +91 6522244551 </p>
			</div>
		</aside>
	</body>
</html>
